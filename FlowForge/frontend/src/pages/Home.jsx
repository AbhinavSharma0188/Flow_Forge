...
import { MdAddCircle, MdOutlineSubscriptions } from "react-icons/md";
  ...
  return (
    <div className="bg-[#0f0f0f] text-white min-h-screen relative">
          ...
          <div className="flex items-center gap-3">
            ...
            {!userData?.photoUrl ? (
              ...
              <img
                ...
                alt="img"
                className="w-9 h-9 rounded-full object-cover border-1 border-gray-700 hidden md:flex cursor-pointer"
                referrerPolicy="no-referrer"
                onClick={() => setOpen((prev) => !prev)}
                onError={(e) => {
                  e.target.style.display = 'none';
                  e.target.parentElement.innerHTML = '<div class="text-3xl text-gray-400"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 496 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M248 8C111 8 0 119 0 256s111 248 248 248 248-111 248-248S385 8 248 8zm0 96c48.6 0 88 39.4 88 88s-39.4 88-88 88-88-39.4-88-88 39.4-88 88-88zm0 344c-58.7 0-111.3-26.6-146.5-68.2 18.8-35.4 55.6-59.8 98.5-59.8 2.4 0 4.8.4 7.1 1.1 13 4.2 26.6 6.9 40.9 6.9 14.3 0 28-2.7 40.9-6.9 2.3-.7 4.7-1.1 7.1-1.1 42.9 0 79.7 24.4 98.5 59.8C359.3 421.4 306.7 448 248 448z"></path></svg></div>';
                }}
              />
            )}
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-[#0f0f0f] border-t border-gray-800 flex justify-around py-2 z-10">
        ...
        <MobileNavItem onClick={() => navigate("/createpage")} icon={<MdAddCircle className="fill-gray-500 text-4xl w-9 h-9" />} />
