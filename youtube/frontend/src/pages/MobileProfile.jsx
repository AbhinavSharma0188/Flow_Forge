...
import { FaClock, FaHistory, FaList, FaThumbsUp, FaUserCircle } from "react-icons/fa";
  ...
  return (
    <div className="bg-[#0f0f0f] text-white h-[100%] w-[100%] top-[3%] flex flex-col pt-[100px] p-[10px] ">
      ...
      <div className="p-4 flex items-center gap-4 border-b border-gray-800">
        {userData?.photoUrl ? (
          <img src={userData.photoUrl} alt="profile" className="w-16 h-16 rounded-full" referrerPolicy="no-referrer" />
        ) : (
