              ...
              <div className="flex items-center justify-start gap-2">
                {short.channel?.avatar ? (
                  <img
                    ...
                    alt=""
                    className="w-8 h-8 rounded-full border-1 border-gray-700 object-cover"
                  ...
                  <div className="w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center border border-gray-600" onClick={() => navigate(`/channelpage/${short?.channel._id}`)}>
                    <span className="text-xs uppercase text-white">{short.channel?.name?.charAt(0) || "?"}</span>
                  </div>
                )}
                <div className="fallback-icon hidden w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center border border-gray-600" onClick={() => navigate(`/channelpage/${short?.channel._id}`)}>
                  <span className="text-xs uppercase text-white">{short.channel?.name?.charAt(0) || "?"}</span>
                </div>
                <span
